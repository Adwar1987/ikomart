...
<script type="text/javascript" >
        ...
        <div class="breadcrumbs">
            <div class="main-container">
                <ul>
                    ...
                    <li class="bc-dots">...</li>
					<li class="bc-last">Berita & Kegiatan</li>
                </ul>
            </div><!-- .main-container -->
        </div><!-- .breadcrumbs -->
    ...
    <section class="section spad">
        <div class="main-container">
			...
			$sql = "SELECT * from mst_berita  order by tanggal desc";
			//echo $sql;
			...
			?>
				...
				<div class="grid-child f-768-1per2 f-no-margin">
					<img class="img-wrap square-service" border="0" style="width:100%; height:160px;"  src="<?php echo '.'.$data['img']?>">
				</div>
                <div >
				<?php echo "<b>".$data['judul']."</b>"."<br>";
				$sqlcek ="select
					a.id_berita, a.judul, a.sum, a.sumber, a.link, a.isi,
				...
				if ( $rb['thn'] > 0 ){
					...
					echo "<u>".$rb['nm_hr'].", ".$rb['nm_tgl']." ".$rb['nm_bln']." ".$rb['thn']." | ".$data['sumber']."</u><br>";                          
				}else{ 

					echo "<u>".nama_hari($data['tanggal']).", ".Indonesia2Tgl($data['tanggal'])." | ".$data['sumber']."</u><br>";   
				}
				echo  substr($data['sum'],0,150)."...  <br>"; ?>
				<a href="?module=berita&file=bc&id_berita=<?=$rb['id_berita']?>" class="btn btn-rounded btn-red">Detail</a>
				</div>
				</td>
				<?php
				$no =$no + 1;
